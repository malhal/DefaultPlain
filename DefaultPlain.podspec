#
# Be sure to run `pod lib lint DefaultPlain.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/malhal/DefaultPlain"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Malcolm Hall" => "malhal@users.noreply.github.com" }
  s.source           = { :git => "https://github.com/malhal/DefaultPlain.git", :tag => s.version.to_s }
  ...
  #s.resource_bundles = {
  #  'DefaultPlain' => ['Pod/Assets/*.png']
  #}
  s.resources = 'DefaultPlain/*'
